  ...
  return (
    <div className="min-h-screen bg-[#180a38] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
      ...
      <p className="mt-6 sm:mt-8 text-gray-300 text-sm sm:text-base md:text-lg max-w-md mx-auto">
        Start your journey to a more organized and fulfilling life with our powerful Habit Tracker.
        Stay motivated and on track!
      </p>

      <img
        src={image}
        alt="Illustration of a habit tracking concept"
      ...
      <button
        ...
        className="bg-red-500 mt-8 py-2 px-6 sm:px-8 rounded-md text-white font-semibold text-sm sm:text-base hover:bg-red-600 transition-colors duration-300"
      >
        Let's get started
      </button>
    </div>
